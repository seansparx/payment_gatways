...
<table class="procut_item" border="0" cellpadding="4">
  <tr>
	...
	<input type="hidden" name="itemprice" value="2.25" />
    Quantity : <select name="itemQty"><option value="1">1</option><option value="2">2</option><option value="3">3</option></select> 
    <input class="dw_button" type="submit" name="submitbutt" value="Buy (2.25 <?php echo PPL_CURRENCY_CODE; ?>)" />
    </form>
    </td>
  </tr>
</table>
...
<table class="procut_item" border="0" cellpadding="4">
  <tr>
	...
	<input type="hidden" name="itemprice" value="1.99" /> Quantity : <select name="itemQty"><option value="1">1</option><option value="2">2</option><option value="3">3</option></select> 
    <input class="dw_button" type="submit" name="submitbutt" value="Buy (1.99 <?php echo PPL_CURRENCY_CODE; ?>)" />
    </form></td>
  </tr>
</table>
</div>
